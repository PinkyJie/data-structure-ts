...
describe('Binary search tree:', () => {
  const treeSamples = [
    [85, 54, 87, 34, 59, null, null, 19, 50, null, 84, null, null, null, 52, 61, null, null, null, null, null],
    // left skewed tree
    [9, 7, null, 5, null, 3, null, 1, null, null, null],
    // right skewed tree
    [1, null, 3, null, 5, null, 7, null, 9, null, null],
  ];
  ...
  describe('insert():', () => {
    it.each<[string, { treeIndex: number; nodeToInsert: number; result: number[] }]>([
      [
        ...
        { treeIndex: 1, nodeToInsert: 10, result: [9, 7, 10, 5, null, null, null, 3, null, 1, null, null, null] },
      ],
      [
        'at the left sub tree (right skewed tree)',
        { treeIndex: 2, nodeToInsert: 0, result: [1, 0, 3, null, null, null, 5, null, 7, null, 9, null, null] },
      ],
      [
        'at the middle 1',
        {
      ...
      [
        ...
        { treeIndex: 1, nodeToInsert: 4, result: [9, 7, null, 5, null, 3, null, 1, 4, null, null, null, null] },
      ],
      [
        'at the middle (right skewed tree)',
        { treeIndex: 2, nodeToInsert: 4, result: [1, null, 3, null, 5, 4, 7, null, null, null, 9, null, null] },
      ],
      [
        'at the leaf 1',
        {
      ...
      [
        ...
        { treeIndex: 1, nodeToInsert: 0, result: [9, 7, null, 5, null, 3, null, 1, null, 0, null, null, null] },
      ],
      [
        'at the leaf (right skewed tree)',
        { treeIndex: 2, nodeToInsert: 10, result: [1, null, 3, null, 5, null, 7, null, 9, null, 10, null, null] },
      ],
